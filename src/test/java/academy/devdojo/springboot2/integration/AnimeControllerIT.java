...
class AnimeControllerIT {
    ...
    private static final DevDojoUser USER = DevDojoUser.builder()
            .name("Laura Linda")
            .password("{bcrypt}$2a$10$THE1QqkFuvlPYUjitAdAp.DFcJhybBsD8c8CS7Pkw/ZXv394huil2")
            .username("Laurinha")
    ...
    private static final DevDojoUser ADMIN = DevDojoUser.builder()
            .name("Guilherme")
            .password("{bcrypt}$2a$10$/o10Xo3hEn0uRiIwdywkCuE6AZkOrfck2glbXS3bBg/..itsbj0UW")
            .username("gui")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("Laurinha", "cachorro");
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        ...
        Assertions.assertThat(animeResponseEntity.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
    @Test
